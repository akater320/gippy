...
class GeoResource(_object):
    ...
    def __init__(self, *args):
        ...
        __init__(gip::GeoResource self, std::string arg2, int arg3, int arg4, int arg5, std::string arg6, BoundingBox arg7, DataType arg8, std::string arg9, bool arg10) -> GeoResource
...
class GeoRaster(GeoResource):
    ...
    def set_dynamicrange(self, min, max):
        """
        set_dynamicrange(GeoRaster self, int min, int max) -> GeoRaster
    ...
    def histogram(self, bins=100, normalize=True, cumulative=False):
        """
        histogram(GeoRaster self, int bins=100, bool normalize=True, bool cumulative=False) -> CImg< float >
...
class GeoImage(GeoResource):
    ...
    def __init__(self, *args):
        ...
        __init__(gip::GeoImage self, std::string filename, int xsz, int ysz, int nb, std::string proj, BoundingBox bbox, DataType dt, std::string format, bool temp=False) -> GeoImage
    ...
    def set_gain(self, gain):
        """
        set_gain(GeoImage self, float gain) -> GeoImage
    ...
    def set_offset(self, offset):
        """
        set_offset(GeoImage self, float offset) -> GeoImage
