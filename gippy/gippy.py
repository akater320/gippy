...
class GeoImage(GeoResource):
    ...
    def open(*args, **kwargs):
        """
        open(svector filenames, bool update=False, float nodata=0, svector bandnames=std::vector< std::string >({}), 
...
def GeoImage_open(*args, **kwargs):
  """
    GeoImage_open(svector filenames, bool update=False, float nodata=0, svector bandnames=std::vector< std::string >({}), 
        double gain=1.0, double offset=0.0) -> GeoImage
